...
export default function ScratchPad() {
  ...
  function handleDownload(note: Note) {
    ...
    a.href = url;
    a.download = `${note.title.replace(/[^a-zA-Z0-9_\- ]/g, '').replace(/\s+/g, '_')}.md`;
    ...
    <>
      ...
      {isOpen && (
        ...
        >
              ...
              {view === 'editor' && (
                <div className="scratchpad-editor">
                  ...
                  <div className="scratchpad-actions">
                    ...
                    {currentNote && (
                      <>
                        <button className="btn btn-outline" onClick={() => handleDownload(currentNote)}>
                          Download
                        </button>
                        <button
                          className="btn btn-outline"
          ...
          <div className="scratchpad-resize-handle" onMouseDown={handleResizeMouseDown} />
        </div>
      )}
    </>
  );
