...
const CURATED_TIP =
  'This citation matched one of the 92 landmark cases in the offline library, so it was formatted from its official reporter citation and year — instantly and at no AI cost. No badge means the citation was formatted by AI.';
  ...
  return (
    <div>
      ...
      <p style={{ color: 'var(--gray-text)' }}>
        Enter one citation per line (separate multiple citations on one line with semicolons). Citations matching the 92 curated landmark cases are formatted instantly with no AI cost.
      </p>
