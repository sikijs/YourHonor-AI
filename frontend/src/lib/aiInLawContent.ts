...
export const AI_IN_LAW: AiSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "For students, reasoning graphs are a study aid as much as a tool: mapping a doctrine by hand forces you to see which cases are load-bearing, which are peripheral, and which have been quietly undermined. The Doctrine Explorer in this app is a small example — 35 doctrines traced across 85 landmark cases.",
    ],
  },
  {
    id: "courts",
